...
public class TypeManagerServiceImpl implements TypeManagerService {
    ...
    @Override
    public void saveDto(TypeManagerDto dto) {
    ...
    @Override
    public void commit(TypeManagerDto dto) {
        cn.flydiy.hangj.entity.Type type = dto.getType();
    ...
    @Override
    public void updateDto(TypeManagerDto dto) {
        cn.flydiy.hangj.entity.Type type = dto.getType();
    ...
    @Override
    public void updateDtoNoSaveHistory(TypeManagerDto dto) {
        cn.flydiy.hangj.entity.Type type = dto.getType();
    ...
    @Override
    public void batchCommit(List<TypeManagerDto> dtos) {
        if(CollectionUtils.isNotEmpty(dtos)){
            for (TypeManagerDto dto : dtos) {
                commit(dto);
            }
        }
    }
    ...
    public List<Map> dataTableForHangj_typeManager(Map param){
        List<Map> result = typeService.dataTableForHangj_typeManager(param);
        return result;
    }
