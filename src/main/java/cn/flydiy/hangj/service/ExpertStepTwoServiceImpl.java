...
public class ExpertStepTwoServiceImpl implements ExpertStepTwoService {
    ...
    @Override
    public void saveDto(ExpertStepTwoDto dto) {
    ...
    @Override
    public void commit(ExpertStepTwoDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDto(ExpertStepTwoDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDtoNoSaveHistory(ExpertStepTwoDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void batchCommit(List<ExpertStepTwoDto> dtos) {
        if(CollectionUtils.isNotEmpty(dtos)){
            for (ExpertStepTwoDto dto : dtos) {
                commit(dto);
            }
        }
    }
