...
public class ExpertStepOneServiceImpl implements ExpertStepOneService {
    ...
    @Override
    public void saveDto(ExpertStepOneDto dto) {
    ...
    @Override
    public void commit(ExpertStepOneDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDto(ExpertStepOneDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDtoNoSaveHistory(ExpertStepOneDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void batchCommit(List<ExpertStepOneDto> dtos) {
        if(CollectionUtils.isNotEmpty(dtos)){
            for (ExpertStepOneDto dto : dtos) {
                commit(dto);
            }
        }
    }
