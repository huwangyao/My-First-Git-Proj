...
public class HangjTypeCreateServiceImpl implements HangjTypeCreateService {
    ...
    @Override
    public void saveDto(HangjTypeCreateDto dto) {
    ...
    @Override
    public void commit(HangjTypeCreateDto dto) {
        cn.flydiy.hangj.entity.Type type = dto.getType();
    ...
    @Override
    public void updateDto(HangjTypeCreateDto dto) {
        cn.flydiy.hangj.entity.Type type = dto.getType();
    ...
    @Override
    public void updateDtoNoSaveHistory(HangjTypeCreateDto dto) {
        cn.flydiy.hangj.entity.Type type = dto.getType();
    ...
    @Override
    public void batchCommit(List<HangjTypeCreateDto> dtos) {
        if(CollectionUtils.isNotEmpty(dtos)){
            for (HangjTypeCreateDto dto : dtos) {
                commit(dto);
            }
        }
    }
