...
public class ExpertStepThreeServiceImpl implements ExpertStepThreeService {
    ...
    @Override
    public void saveDto(ExpertStepThreeDto dto) {
    ...
    @Override
    public void commit(ExpertStepThreeDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDto(ExpertStepThreeDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDtoNoSaveHistory(ExpertStepThreeDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void batchCommit(List<ExpertStepThreeDto> dtos) {
        if(CollectionUtils.isNotEmpty(dtos)){
            for (ExpertStepThreeDto dto : dtos) {
                commit(dto);
            }
        }
    }
