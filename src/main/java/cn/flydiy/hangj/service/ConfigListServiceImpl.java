...
public class ConfigListServiceImpl implements ConfigListService {
    ...
    @Override
    public void saveDto(ConfigListDto dto) {
    ...
    @Override
    public void commit(ConfigListDto dto) {
        cn.flydiy.hangj.entity.BannerConfig bannerConfig = dto.getBannerConfig();
    ...
    @Override
    public void updateDto(ConfigListDto dto) {
        cn.flydiy.hangj.entity.BannerConfig bannerConfig = dto.getBannerConfig();
    ...
    @Override
    public void updateDtoNoSaveHistory(ConfigListDto dto) {
        cn.flydiy.hangj.entity.BannerConfig bannerConfig = dto.getBannerConfig();
    ...
    @Override
    public void batchCommit(List<ConfigListDto> dtos) {
        if(CollectionUtils.isNotEmpty(dtos)){
            for (ConfigListDto dto : dtos) {
                commit(dto);
            }
        }
    }
    ...
    public List<Map> dataTableForHangj_configList(cn.flydiy.hangj.entity.BannerConfig bannerConfig) {
        List<Map> result = bannerConfigService.queryPageMapByParams(bannerConfig);
        return result;
    }
}
