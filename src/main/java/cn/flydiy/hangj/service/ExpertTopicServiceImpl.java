...
public class ExpertTopicServiceImpl implements ExpertTopicService {
    ...
    @Override
    public void saveDto(ExpertTopicDto dto) {
    ...
    @Override
    public void commit(ExpertTopicDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDto(ExpertTopicDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void updateDtoNoSaveHistory(ExpertTopicDto dto) {
        cn.flydiy.hangj.entity.Info info = dto.getInfo();
    ...
    @Override
    public void batchCommit(List<ExpertTopicDto> dtos) {
        if(CollectionUtils.isNotEmpty(dtos)){
            for (ExpertTopicDto dto : dtos) {
                commit(dto);
            }
        }
    }
